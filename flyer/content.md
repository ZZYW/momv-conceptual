...
[SUBTITLE]
A research-creation artifact · On time, memory, systems.
...
[INTRO]
*Mountain of Many Voices* (MoMV) is a research-creation artifact.
...
He sees the world through his own world-view.

[CALLOUT 4]
and makes a world-making input.

In MoMV, the options are often "world-making" choices. They do not simply ask the player what he wants to do inside an already established world. They allow the player to affect what exists, what is true, and what kind of world this story is becoming.

[CALLOUT 5]
The system remembers this act and absorbs it. In this sense, the world becomes a slightly different world.

The player's input is inscribed into memory. All future operations are then grounded in this memory as part of their context. The LLM participates throughout the system's operations, from processing player input to generating new options and passages of the story.

[CALLOUT 6]
The new system produces a different weather: mood, pressure, direction.

This language is metaphorical. Technically, it means that future generations are conditioned by memory. The system might read the spirit of the story as moving toward nostalgia and elegy, and then continue in that direction. Or it might read the same accumulated material as a political act, and generate a counter-movement in the plot. These readings depend on the "interpretive frames" authored by the writers. These frames are part of procedure of the system.

[CALLOUT 7]
and what could be called new options for the next player. When she arrives, she brings her own life and her own game. There is now also a world shaped by previous encounters between the world and others.

The difference is not merely mechanical, as if the story now contains a few altered words or a slightly shifted plot. For the next player, the world revealed by the story as a whole is different, when we encounter a story or a system, we do not perceive each part in isolation. We perceive a unity: a mood, an inclination, a sense of what the world means and where it is tending.

[CALLOUT 8]
She then acts. The result of her act is already possible only because the world exists as the outcome of previous encounters. She leaves with both herself and the story changed.

The system is altered mechanically through input and memory updates. It is also altered meaningfully, because the story-world has changed in how it can be encountered, interpreted, and continued. The player also leaves changed, as we are always shaped and reshaped by the narratives we pass through.
